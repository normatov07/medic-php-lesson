...
#text{
  ...
  <title>Dorixona platformasi</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Dorixona platformasi</div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="medicdash.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Bosh sahifa</span>
              </a>
            </li>
			<li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="medicalc.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Mahsulotlar</span>
              </a>
            </li>
			<li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="pos.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Buyurtma</span>
              </a>
            </li>
			<li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="transactions.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">O'tkazmalar</span>
              </a>
            </li>
			<li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="myappoint.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Murojaatlar</span>
              </a>
            </li>
