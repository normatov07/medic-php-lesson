      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
              <span>© Dorixona qidiruv platformasi <?Php echo date('Y');?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Chiqishni xohlaysizmi?</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body"><?php echo  $_SESSION['FIRST_NAME']; ?> haqiqatdan ham chiqmoqchimisiz?</div>
...
<div id="overlay" onclick="off()">
  <div id="text">Men <?php echo  $_SESSION['FIRST_NAME'];?><BR>
    <?php echo  $_SESSION['PROVINCE']. ' '.$_SESSION['CITY'] ;?> dan</div>
</div>
<script>
function on() {
...
$opt .= "</select>";
        ...
        $query = "SELECT ID, e.FIRST_NAME, e.NID, e.GENDER, USERNAME, PASSWORD, e.EMAIL, PHONE_NUMBER, j.JOB_TITLE, e.PASSWORD2, t.TYPE, l.PROVINCE, l.CITY
                      FROM users u
                      join customer1 e on u.EMPLOYEE_ID = e.EMPLOYEE_ID
  ...
  <div class="modal fade" id="settingsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Foydalanuvchi ma'lumotlarini tahririlash</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">
          <form role="form" method="post" action="settings_edit.php">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Familyasi" name="lastname" value="<?php echo $b; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" placeholder="Parol" name="password" value="<?php echo $i; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Lavozim" name="role" value="<?php echo $h; ?>" readonly>
                </div>
              </div>
