...
this.showCities=function(province,element){var str='<option selected disabled>Shaxar yoki tuman</option>';var elem='';if((province.indexOf(".")!==-1||province.indexOf("#")!==-1)){elem=province}
