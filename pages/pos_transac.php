                ...
                for($i=1; $i<=$countID; $i++)
                  {
                   ...
                   $query = "INSERT INTO `transaction_details`
                    ...
                    $query111 = "INSERT INTO `transaction`
                               (`TRANS_ID`, `CUST_ID`,`CUST`, `NUMOFITEMS`, `SUBTOTAL`, `LESSVAT`, `NETVAT`, `ADDVAT`, `GRANDTOTAL`, `CASH`, `DATE`, `TRANS_D_ID`)
                               VALUES (Null,'{$customer}','{$customer1}','{$countID}','{$subtotal}','{$lessvat}','{$netvat}','{$addvat}','{$total}','{$cash}','{$date}','{$today}')";
