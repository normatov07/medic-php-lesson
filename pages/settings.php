      ...
      ?>
        ...
        <div class="card shadow mb-4 col-xs-12 col-md-12 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Akkaunt ma'lumotlarini yangilash</h4>
            </div>
            <div class="card-body">
            ...
            <form role="form" method="post" action="settings_edit.php">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Ism" name="firstname" value="<?php echo $a; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Usrname" name="username" value="<?php echo $d; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Hudu" name="province" value="<?php echo $j; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Shaxar/Tuman" name="city" value="<?php echo $k; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
              ...
              <hr>
                ...
                <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-edit fa-fw"></i>Yangilash</button>    
              </form>  
            </div>
          </div>        
