...
$result = mysqli_query($db, $sqlforhosy) or die ("Yomon SQL: $sqlforhosy");

$hosy = "<select class='form-control' name='hosy' required>
        <option value='' disabled selected hidden>Tibbiyot markazini tanlang</option>";
  while ($row = mysqli_fetch_assoc($result)) {
...
<head>
  ...
  <title>Dorixona qidiruv platformasi</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">O'zingizga qulay vaqtda dorilarni qidiring va toping!</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-user" placeholder="Parol" name="password" type="password" value="">
                    </div>
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" id="customCheck">
                        <label class="custom-control-label" for="customCheck">Eslab qolish</label>
                      </div>
                    </div>
                    <button class="btn btn-primary btn-user btn-block" type="submit" name="btnlogin">Kirish</button>
					<a  href="#" data-toggle="modal" data-target="#employeeModal" type="button" class="btn btn-success btn-user btn-block" ><i class="fas fa-fw fa-plus"></i>Akkaunt yaratish</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="register.php?action=add">
              ...
              <div class="form-group">
                <input class="form-control" placeholder="Familya" name="nid" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input class="form-control" placeholder="Telefon raqam" name="phonenumber" required>
              </div>
              <div class="form-group">
                <?php
                  echo $job;
              ...
              <div class="form-group">
                <input class="form-control" type="text"  placeholder="Parol" name="password" required>
              </div>
              <hr>
