    ...
    echo '</pre>';
                ...
                <div class="col-lg-12" >
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Bosh sahifa</h4>
                  </div>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Mening o'tkazmalarim</div>
	  ...
	  <div class="col-md-3">
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Mening murojaatlarim</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
	   ...
	   <div class="col-md-3">
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Tasdiqlangan murojaatlar</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                        <?php 
	   ...
	   <div class="col-md-3">
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Kutilayotgan murojaatlar</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                        <?php 
