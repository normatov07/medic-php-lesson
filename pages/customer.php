  ...
  console.log($.getCities("Batangas")); 
          ...
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Ishchi qo'shish</h4>
            </div>
            <a href="employee.php?action=add" type="button" class="btn btn-primary bg-gradient-primary">Ortga</a>
            <div class="card-body">
              <div class="table-responsive">
                        <form role="form" method="post" action="emp_transac.php?action=add">
                            ...
                            <div class="form-group">
                              <input type="date" id="FromDate" name="hireddate" value="yyyy-oo-kk" class="form-control" />
                            </div>
                            <div class="form-group">
                            ...
                            <button type="reset" class="btn btn-danger btn-block"><i class="fa fa-times fa-fw"></i>Yangilash</button>
