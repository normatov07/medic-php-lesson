...
$result2 = mysqli_query($db, $sql2) or die ("Yomin SQL: $sql2");

$sup = "<select class='form-control' name='supplier' required>
        <option disabled selected hidden>Tibbiyot markazi | Dorixona tanlang</option>";
...
?>
            ...
            <div class="card shadow mb-4">
                    ...
                    <h4 class="m-1 text-lg text-danger">Tibbiyot markazni yoki mahsulot nomi bo'yicha qidiring, so'ngra joylashuvni ko'ring</h4>
                  </div>
            <div class="card-body">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['BYUSER'].'</td>';
                      echo '<td align="right"> <div class="btn-group">
                              <a type="button" class="btn btn-primary bg-gradient-primary" href="prom_searchfrm.php?action=edit & id='.$row['PRODUCT_CODE'] . '"><i class="fas fa-fw fa-list-alt"></i> Tibbiyot markazi | Dorixona manzilini korish</a>
                            <div class="btn-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="addmedic.php?action=add">
           ...
           <div class="form-group">
             <textarea rows="5" cols="50" textarea" class="form-control" placeholder="Dori haqid" name="description" required></textarea>
           </div>
           <div class="form-group">
             <input type="number"  min="1" max="999999999" class="form-control" placeholder="Miqdori" name="quantity" required>
           </div>
           <div class="form-group">
             <input type="number"  min="1" max="999999999" class="form-control" placeholder="Bosh narxi" name="onhand" required>
           </div>
           <div class="form-group">
