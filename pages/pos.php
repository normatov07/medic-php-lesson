    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Tibbiy mahsulotlar kategoriyasi</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#devices" data-toggle="tab">Tibbiy asboblar</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#drugs" data-toggle="tab">Farmatsevtik preparatlar</a>
                              </li>
...
<!-- END TAB PANE AREA - ANG UNOD KA TABS ARA SA TABPANE.PHP -->
        ...
        <div class="card-header py-3 bg-white">
          <h4 class="m-2 font-weight-bold text-primary">Sizning hisob malumotlaringiz</h4>
        </div>
...
<form role="form" method="post" action="pos_transac.php?action=add">
  ...
  <input type="hidden" name="role" value="<?php echo $_SESSION['JOB_TITLE']; ?>">
        ...
        <table class="table">    
        <tr>  
             <th width="55%">Maxsulot kodi</th>  
             <th width="10%">Miqdori</th>  
             <th width="15%">Narxi</th>  
             <th width="15%">Umumiy</th>  
             <th width="5%">Buyruqlar</th>  
        </tr>  
        <?php  
