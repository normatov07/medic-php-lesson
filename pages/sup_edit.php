...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Yetkazib beruvchini tahrirlash</h4>
            </div>
            ...
            <form role="form" method="post" action="sup_edit1.php">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Kompaniya nomi" name="name" value="<?php echo $a; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Hudud" name="province" value="<?php echo $b; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="Viloyat/Tuman" name="city" value="<?php echo $c; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
                   <input class="form-control" placeholder="Telefon raqami" name="phone" value="<?php echo $d; ?>" required>
                </div>
              </div>
              <hr>
