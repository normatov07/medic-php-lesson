...
$sup = "<select class='form-control' name='supplier'>
        <option disabled selected>Yetkazib beruvchini tanlang</option>";
...
?>
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Maxsulot qo'shish</h4>
            </div>
                      ...
                      <div class="table-responsive">
                        ...
                        <form role="form" method="post" action="pro_transac.php?action=add">
                            <div class="form-group">
                              <input class="form-control" placeholder="Maxsulot kodi" name="prodcode" required>
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Nomi" name="name" required>
                            </div>
                            <div class="form-group">
                              <textarea rows="5" cols="50" texarea" class="form-control" placeholder="Maxsulot haqida" name="description" required></textarea>
                            </div>
                            <div class="form-group">
                              <input type="number"  min="1" max="999999999" class="form-control" placeholder="Miqdori" name="quantity" required>
                            </div>
                            <div class="form-group">
                              <input type="number"  min="1" max="999999999" class="form-control" placeholder="Mavjud" name="onhand" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <input type="datet" class="form-control" placeholder="Saqlanish muddati" name="datestock" required>
                            </div>
                            <hr>
                            <button type="submit" class="btn btn-success btn-block"><i class="fa fa-check fa-fw"></i>Saqlash</button>
                            <button type="reset" class="btn btn-danger btn-block"><i class="fa fa-times fa-fw"></i>Bekor qilish</button>
